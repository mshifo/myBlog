...
if( isset( $_SERVER['HTTP_HOST'] ) ) {
	$loader
		->set( 'WP_HOME', $scheme . '://' . $_SERVER['HTTP_HOST']. '/worky/blogy/wp' )
		->set( 'WP_SITEURL', $loader->get( 'WP_HOME' ))
		->set( 'WP_CONTENT_URL',  $scheme . '://' . $_SERVER['HTTP_HOST']. '/worky/blogy/content' );
}
